...
FROM (
    SELECT 
    TIMESTAMP_TRUNC(r.evt_block_time, day) AS block_date, 
    r.evt_block_time, r.evt_block_number, r.evt_index,
        ...
        tf.to as user_address
            ...
            'Other' AS to_name, cast(amount as FLOAT64) / cast(1e18 as FLOAT64) AS op_amount_decimal
            --get last
        ...
        and cast(amount as FLOAT64)/cast(1e18 as FLOAT64) > 0
