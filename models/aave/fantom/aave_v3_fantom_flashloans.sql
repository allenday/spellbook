...
WITH flashloans AS (
    ...
    FROM {{ source('aave_v3_fantom','Pool_evt_FlashLoan') }} AS flash
    LEFT JOIN {{ ref('tokens_fantom_erc20') }} AS erc20 ON flash.asset = erc20.contract_address
