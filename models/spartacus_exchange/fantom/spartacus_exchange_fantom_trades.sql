...
{% set project_start_date = '2022-04-21' %} -- min(evt_block_time) from spartacus_exchange_fantom.Pair_evt_Swap
...
with dexs as (
    ...
    select
        ...
        t.evt_index
    from
        {{ source('spartacus_exchange_fantom', 'Pair_evt_Swap') }} as t
    inner join {{ source('spartacus_exchange_fantom', 'BaseV1Factory_evt_PairCreated') }} as f
