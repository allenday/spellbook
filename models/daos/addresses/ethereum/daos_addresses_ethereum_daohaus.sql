...
get_daohaus_molochs as ( -- molochs are daos and this is getting a list of molochs created through daohaus 
        SELECT 
            ...
            {{ var('safe_cast') }}(date_trunc('day', block_time) as DATE) as created_date, 
...
mapped_wallets as (
        ...
        UNION DISTINCT -- molochs are wallet addresses as well so using a union here since there'll be duplicates as i'm unioning the moloch addresses & minion addresses 
