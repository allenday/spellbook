...
SELECT
    ...
    description
FROM (
    VALUES ('0x8ed95d1746bf1e4dab58d8ed4724f1ef95b20db0', '0x', 'Erc20 Bridge Proxy'),
    ...
    ('0x43de2d77bf8027e25dbd179b491e8d64f38398aa', 'deBridgeGate', cast(NULL AS VARCHAR(5))),
    ...
    ('0x75ace7a086ea0fb1a79e43cc6331ad053d8c67cb', 'Gluon Network', cast(NULL AS VARCHAR(5))),
