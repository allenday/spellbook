...
WITH zora_trades AS (
    ...
    , JSON_EXTRACT_SCALAR(z3_o1_ee.a, '$.tokenId') AS token_id
    , 'Offer Accepted' AS trade_category
    , z3_o1_ee.userA AS seller
    , z3_o1_ee.userB AS buyer
    , JSON_EXTRACT_SCALAR(z3_o1_ee.b, '$.amount') AS amount_raw
    , JSON_EXTRACT_SCALAR(z3_o1_ee.b, '$.tokenContract') AS currency_contract
    , JSON_EXTRACT_SCALAR(z3_o1_ee.a, '$.tokenContract') AS nft_contract_address
    ...
    LEFT JOIN {{ source('zora_v3_ethereum','OffersV1_evt_RoyaltyPayout') }} z3_o1_rp ON z3_o1_ee.evt_block_time=z3_o1_rp.evt_block_time
        ...
        AND JSON_EXTRACT_SCALAR(z3_o1_ee.a, '$.tokenContract')=z3_o1_rp.tokenContract
        AND JSON_EXTRACT_SCALAR(z3_o1_ee.a, '$.tokenId')=z3_o1_rp.tokenId
        {% if is_incremental() %}
        AND z3_o1_rp.evt_block_time >= date_trunc("day", CURRENT_TIMESTAMP() - interval '1 week')
        {% endif %}
    UNION ALL
    SELECT 'v3' AS version
    , z3_a0_ee.evt_block_time AS block_time
    , z3_a0_ee.evt_block_number AS block_number
    , JSON_EXTRACT_SCALAR(z3_a0_ee.a, '$.tokenId') AS token_id
    , 'Buy' AS trade_category
    , z3_a0_ee.userA AS seller
    , z3_a0_ee.userB AS buyer
    , JSON_EXTRACT_SCALAR(z3_a0_ee.b, '$.amount') AS amount_raw
    , JSON_EXTRACT_SCALAR(z3_a0_ee.b, '$.tokenContract') AS currency_contract
    , JSON_EXTRACT_SCALAR(z3_a0_ee.a, '$.tokenContract') AS nft_contract_address
    ...
    LEFT JOIN {{ source('zora_v3_ethereum','AsksV1_0_evt_RoyaltyPayout') }} z3_a0_rp ON z3_a0_ee.evt_block_time=z3_a0_rp.evt_block_time
        ...
        AND JSON_EXTRACT_SCALAR(z3_a0_ee.a, '$.tokenContract')=z3_a0_rp.tokenContract
        AND JSON_EXTRACT_SCALAR(z3_a0_ee.a, '$.tokenId')=z3_a0_rp.tokenId
        {% if is_incremental() %}
        AND z3_a0_rp.evt_block_time >= date_trunc("day", CURRENT_TIMESTAMP() - interval '1 week')
        {% endif %}
    UNION ALL
    SELECT 'v3' AS version
    , z3_a1_ee.evt_block_time AS block_time
    , z3_a1_ee.evt_block_number AS block_number
    , JSON_EXTRACT_SCALAR(z3_a1_ee.a, '$.tokenId') AS token_id
    , 'Buy' AS trade_category
    , z3_a1_ee.userA AS seller
    , z3_a1_ee.userB AS buyer
    , JSON_EXTRACT_SCALAR(z3_a1_ee.b, '$.amount') AS amount_raw
    , JSON_EXTRACT_SCALAR(z3_a1_ee.b, '$.tokenContract') AS currency_contract
    , JSON_EXTRACT_SCALAR(z3_a1_ee.a, '$.tokenContract') AS nft_contract_address
    ...
    LEFT JOIN {{ source('zora_v3_ethereum','AsksV1_1_evt_RoyaltyPayout') }} z3_a1_rp ON z3_a1_ee.evt_block_time=z3_a1_rp.evt_block_time
        ...
        AND JSON_EXTRACT_SCALAR(z3_a1_ee.a, '$.tokenContract')=z3_a1_rp.tokenContract
        AND JSON_EXTRACT_SCALAR(z3_a1_ee.a, '$.tokenId')=z3_a1_rp.tokenId
        {% if is_incremental() %}
        AND z3_a1_rp.evt_block_time >= date_trunc("day", CURRENT_TIMESTAMP() - interval '1 week')
        {% endif %}
    UNION ALL
    SELECT 'v3' AS version
    ...
    , JSON_EXTRACT_SCALAR(z3_rafe_ae.auction, '$.seller') AS seller
    , JSON_EXTRACT_SCALAR(z3_rafe_ae.auction, '$.highestBidder') AS buyer
    , JSON_EXTRACT_SCALAR(z3_rafe_ae.auction, '$.highestBid') AS amount_raw
    ...
    LEFT JOIN {{ source('zora_v3_ethereum','ReserveAuctionFindersEth_evt_RoyaltyPayout') }} z3_rafe_rp ON z3_rafe_ae.evt_block_time=z3_rafe_rp.evt_block_time
        ...
        {% if is_incremental() %}
        AND z3_rafe_rp.evt_block_time >= date_trunc("day", CURRENT_TIMESTAMP() - interval '1 week')
        {% endif %}
    UNION ALL
    SELECT 'v3' AS version
    ...
    , JSON_EXTRACT_SCALAR(z3_ape_af.ask, '$.seller') AS seller
    , JSON_EXTRACT_SCALAR(z3_ape_af.ask, '$.buyer') AS buyer
    , JSON_EXTRACT_SCALAR(z3_ape_af.ask, '$.price') AS amount_raw
    , '0x0000000000000000000000000000000000000000' AS currency_contract
    ...
    LEFT JOIN {{ source('zora_v3_ethereum','AsksPrivateEth_evt_RoyaltyPayout') }} z3_ape_rp ON z3_ape_af.evt_block_time=z3_ape_rp.evt_block_time
        ...
        {% if is_incremental() %}
        AND z3_ape_rp.evt_block_time >= date_trunc("day", CURRENT_TIMESTAMP() - interval '1 week')
        {% endif %}
    UNION ALL
    SELECT 'v3' AS version
    ...
    LEFT JOIN {{ source('zora_v3_ethereum','AsksCoreEth_evt_RoyaltyPayout') }} z3_ace_rp ON z3_ace_af.evt_block_time=z3_ace_rp.evt_block_time
        ...
        {% if is_incremental() %}
        AND z3_ace_rp.evt_block_time >= date_trunc("day", CURRENT_TIMESTAMP() - interval '1 week')
        {% endif %}
    UNION ALL
    SELECT 'v3' AS version
    ...
    , 'Buy' AS trade_category
    , JSON_EXTRACT_SCALAR(z3_race_ae.auction, '$.seller') AS seller
    , JSON_EXTRACT_SCALAR(z3_race_ae.auction, '$.highestBidder') AS buyer
    , JSON_EXTRACT_SCALAR(z3_race_ae.auction, '$.highestBid') AS amount_raw
    , '0x0000000000000000000000000000000000000000' AS currency_contract
    ...
    LEFT JOIN {{ source('zora_v3_ethereum','ReserveAuctionCoreEth_evt_RoyaltyPayout') }} z3_race_rp ON z3_race_ae.evt_block_time=z3_race_rp.evt_block_time
        ...
        {% if is_incremental() %}
        AND z3_race_rp.evt_block_time >= date_trunc("day", CURRENT_TIMESTAMP() - interval '1 week')
        {% endif %}
    UNION ALL
    SELECT 'v3' AS version
    ...
    , 'Buy' AS trade_category
    , JSON_EXTRACT_SCALAR(z3_racerc_ae.auction, '$.seller') AS seller
    , JSON_EXTRACT_SCALAR(z3_racerc_ae.auction, '$.highestBidder') AS buyer
    , JSON_EXTRACT_SCALAR(z3_racerc_ae.auction, '$.highestBid') AS amount_raw
    , JSON_EXTRACT_SCALAR(z3_racerc_ae.auction, '$.currency') AS currency_contract
    ...
    LEFT JOIN {{ source('zora_v3_ethereum','ReserveAuctionCoreErc20_evt_RoyaltyPayout') }} z3_racerc_rp ON z3_racerc_ae.evt_block_time=z3_racerc_rp.evt_block_time
        ...
        {% if is_incremental() %}
        AND z3_racerc_rp.evt_block_time >= date_trunc("day", CURRENT_TIMESTAMP() - interval '1 week')
        {% endif %}
    UNION ALL
    SELECT 'v3' AS version
    ...
    , 'Buy' AS trade_category
    , JSON_EXTRACT_SCALAR(z3_raferc_ae.auction, '$.seller') AS seller
    , JSON_EXTRACT_SCALAR(z3_raferc_ae.auction, '$.highestBidder') AS buyer
    , JSON_EXTRACT_SCALAR(z3_raferc_ae.auction, '$.highestBid') AS amount_raw
    , JSON_EXTRACT_SCALAR(z3_raferc_ae.auction, '$.currency') AS currency_contract
    ...
    LEFT JOIN {{ source('zora_v3_ethereum','ReserveAuctionFindersErc20_evt_RoyaltyPayout') }} z3_raferc_rp ON z3_raferc_ae.evt_block_time=z3_raferc_rp.evt_block_time
        ...
        {% if is_incremental() %}
        AND z3_raferc_rp.evt_block_time >= date_trunc("day", CURRENT_TIMESTAMP() - interval '1 week')
        {% endif %}
    UNION ALL
    SELECT 'v3' AS version
    ...
    , 'Buy' AS trade_category
    , JSON_EXTRACT_SCALAR(z3_rale_ae.auction, '$.seller') AS seller
    , JSON_EXTRACT_SCALAR(z3_rale_ae.auction, '$.highestBidder') AS buyer
    , JSON_EXTRACT_SCALAR(z3_rale_ae.auction, '$.highestBid') AS amount_raw
    , '0x0000000000000000000000000000000000000000' AS currency_contract
    ...
    LEFT JOIN {{ source('zora_v3_ethereum','ReserveAuctionListingEth_evt_RoyaltyPayout') }} z3_rale_rp ON z3_rale_ae.evt_block_time=z3_rale_rp.evt_block_time
        ...
        {% if is_incremental() %}
        AND z3_rale_rp.evt_block_time >= date_trunc("day", CURRENT_TIMESTAMP() - interval '1 week')
        {% endif %}
    UNION ALL
    SELECT 'v3' AS version
    , z3_rale_ae.evt_block_time AS block_time
    ...
    , JSON_EXTRACT_SCALAR(z3_rale_ae.auction, '$.highestBidder') AS buyer
    , JSON_EXTRACT_SCALAR(z3_rale_ae.auction, '$.highestBid') AS amount_raw
    , JSON_EXTRACT_SCALAR(z3_rale_ae.auction, '$.currency') AS currency_contract
    , z3_rale_ae.tokenContract AS nft_contract_address
    , z3_rale_ae.contract_address AS project_contract_address
    , z3_rale_ae.evt_tx_hash AS tx_hash
    , z3_rale_rp.amount AS royalty_fee_amount_raw
    ...
    {% if is_incremental() %}
    WHERE z2_ae.evt_block_time >= date_trunc("day", CURRENT_TIMESTAMP() - interval '1 week')
    {% endif %}
    UNION ALL
    ...
    , JSON_EXTRACT_SCALAR(z1_bf.bid, '$.recipient') AS buyer
    , JSON_EXTRACT_SCALAR(z1_bf.bid, '$.amount') AS amount_raw
    , JSON_EXTRACT_SCALAR(z1_bf.bid, '$.currency') AS currency_contract
    ...
    {% if is_incremental() %}
    AND z1_mt.evt_block_time >= date_trunc("day", CURRENT_TIMESTAMP() - interval '1 week')
    {% endif %}
    WHERE JSON_EXTRACT_SCALAR(z1_bf.bid, '$.bidder') != '0xe468ce99444174bd3bbbed09209577d25d1ad673'
    )
...
SELECT 'ethereum' AS blockchain
    ...
    , zt.version
    , zt.block_time
    , TIMESTAMP_TRUNC(zt.block_time, day) AS block_date
    , zt.block_number
    , zt.token_id
    ...
    , CAST(zt.amount_raw AS BIGNUMERIC) AS amount_raw
    ...
    , CAST(SUM(zt.royalty_fee_amount_raw) AS FLOAT64) AS royalty_fee_amount_raw
    ...
    , CAST(COALESCE(100.0*SUM(zt.royalty_fee_amount_raw)/zt.amount_raw, 0) AS FLOAT64) AS royalty_fee_percentage
    , ARRAY_AGG(zt.royalty_fee_receive_address ORDER BY zt.royalty_fee_receive_address LIMIT 1)[OFFSET(0)] AS royalty_fee_receive_address
    , CASE WHEN zt.currency_contract='0x0000000000000000000000000000000000000000' THEN 'ETH'
...
LEFT JOIN {{ source('erc721_ethereum','evt_transfer') }} erc721 ON erc721.evt_block_time=zt.block_time
    ...
    {% if is_incremental() %}
    AND erc721.evt_block_time >= date_trunc("day", CURRENT_TIMESTAMP() - interval '1 week')
    {% endif %}
LEFT JOIN {{ source('prices','usd') }} pu ON pu.blockchain='ethereum'
    AND pu.minute=TIMESTAMP_TRUNC(zt.block_time, minute)
