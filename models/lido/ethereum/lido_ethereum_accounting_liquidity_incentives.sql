...
ethereum_liquidity_incentives_txns AS (
    ...
    SELECT 
        ...
        CASE 
            WHEN contract_address = LOWER('0x0914d4ccc4154ca864637b0b653bc5fd5e1d3ecf') THEN LOWER('0x5a98fcbea516cf06857215779fd812ca3bef1b32') 
            WHEN contract_address = LOWER('0xfdb794692724153d1488ccdbe0c56c252596735f') THEN LOWER('0x5a98fcbea516cf06857215779fd812ca3bef1b32') 
            WHEN contract_address = LOWER('0x13ad51ed4f1b7e9dc168d8a00cb3f4ddd85efa60') THEN LOWER('0x5a98fcbea516cf06857215779fd812ca3bef1b32') 
