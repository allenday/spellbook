...
select * FROM UNNEST(ARRAY<STRUCT<address STRING>> [STRUCT(LOWER('0x558247e365be655f9144e1a0140d793984372ef3')),
STRUCT(LOWER('0x6DC9657C2D90D57cADfFB64239242d06e6103E43')),
STRUCT(LOWER('0xDB2364dD1b1A733A690Bf6fA44d7Dd48ad6707Cd')),
STRUCT(LOWER('0x586b9b2F8010b284A0197f392156f1A7Eb5e86e9')),
STRUCT(LOWER('0xC976903918A0AF01366B31d97234C524130fc8B1')),
STRUCT(LOWER('0x53773e034d9784153471813dacaff53dbbb78e8c')),
STRUCT(LOWER('0x883f91D6F3090EA26E96211423905F160A9CA01d')),
STRUCT(LOWER('0xf6502Ea7E9B341702609730583F2BcAB3c1dC041')),
STRUCT(LOWER('0x82AF9d2Ea81810582657f6DC04B1d7d0D573F616')),
STRUCT(LOWER('0x351806B55e93A8Bcb47Be3ACAF71584deDEaB324')),
STRUCT(LOWER('0x9e2b6378ee8ad2A4A95Fe481d63CAba8FB0EBBF9')),
STRUCT(LOWER('0xaf8aE6955d07776aB690e565Ba6Fbc79B8dE3a5d'))])
),



ldo_referral_payment_txns AS ( 
   SELECT evt_block_time, CAST(_amount AS FLOAT64) AS amnt, evt_tx_hash, _to, _from, contract_address
