...
select
    ...
    CAST(platform_fee_amount / amount_original as DOUBLE) as platform_fee_percentage,
    royalty_fee_amount_raw,
    royalty_fee_amount,
    royalty_fee_amount_usd,
    CAST(royalty_fee_amount / amount_original as DOUBLE) as royalty_fee_percentage,
