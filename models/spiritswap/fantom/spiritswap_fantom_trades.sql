...
{% set project_start_date = '2021-04-20' %} -- min(evt_block_time) from spiritswap_fantom.Pair_evt_Swap
...
with dexs as (
    ...
    select
        ...
        t.evt_index
    from
        {{ source('spiritswap_fantom', 'Pair_evt_Swap') }} as t
    inner join {{ source('spiritswap_fantom', 'Factory_evt_PairCreated') }} as f
