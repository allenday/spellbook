...
WITH dexs AS (
    ...
    SELECT
        ...
        CASE
            WHEN quotetoken = '0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee'
                THEN '0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2'
            ELSE quotetoken
        END AS token_bought_address,
        CASE
            WHEN basetoken = '0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee'
                THEN '0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2'
            ELSE basetoken
        ...
        '' AS trace_address,
        t.evt_index
    FROM {{ source('pancakeswap_v2_ethereum', 'PancakeSwapMMPool_evt_Swap') }} AS t
    {% if is_incremental() %}
