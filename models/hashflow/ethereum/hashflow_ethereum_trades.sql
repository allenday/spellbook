...
select
    ...
    CAST(hashflow_trades.maker_token_amount * power(10, erc20a.decimals) AS BIGNUMERIC) as token_bought_amount_raw,
    CAST(hashflow_trades.taker_token_amount * power(10, erc20b.decimals) AS BIGNUMERIC) as token_sold_amount_raw,
