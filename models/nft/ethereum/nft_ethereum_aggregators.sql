...
FROM
    (
        ...
        -- Gem Single Contract Checkout 1
        , ('0x0000000031f7382a812c64b604da4fc520afef4b', 'Gem')
        -- Gem Single Contract Checkout 2
        ...
        -- Gem's X2Y2 Batch Buys
        , ('0x9e97195f937c9372fe5fda5e3b86e9b88cbefed7', 'Gem')
        -- Gem's Blur Batch Buys
        , ('0xf22007700b8c443bcb36a39580f7804bffdb1169', 'Gem')
        -- X2Y2's OpenSea Sniper
        , ('0x56dd5bbede9bfdb10a2845c4d70d4a2950163044', 'X2Y2')
        -- Element NFT Marketplace Aggregator
        , ('0x69cf8871f61fb03f540bc519dd1f1d4682ea0bf6', 'Element')
        -- Element NFT Marketplace Aggregator 2
        , ('0xb4e7b8946fa2b35912cc0581772cccd69a33000c', 'Element')
        , ('0x39da41747a83aee658334415666f3ef92dd0d541', 'Blur') -- Blur
        -- NFTInit.com
        , ('0x7f6cdf5869bd780ea351df4d841f68d73cbcc16b', 'NFTInit')
        ...
        -- Reservoir v6
        , ('0x178a86d36d89c7fdebea90b739605da7b131ff6a', 'Reservoir')
        -- Rarity Garden v2
        , ('0x39b6862c4783db2651d64bc160349dc9a15f1fb7', 'Rarity Garden')
        -- Rarity Garden v1.02
        , ('0x9d0a89bc35fb160a076de0341d9280830d3013ca', 'Rarity Garden')
        ...
        -- Magic Eden
        , ('0x1ee3151cff01321059e3865214379b85c79ca984', 'Magic Eden')
        -- Alpha Sharks
        , ('0x141efc30c4093bc0f8204accb8afa6643fddecf2', 'Alpha Sharks')
        -- Alpha Sharks 2.0
        , ('0x552b16d19dbad7af2786fe5a40d96d2a5c09428c', 'Alpha Sharks')
        -- Uniswap's Universal Router
