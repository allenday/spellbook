...
FROM (VALUES
        ...
        ('0x4635b5a4da92a75a2b456f41ce67ec7b984b88ce', 'Joel Meyerowitz', 'Joel Meyerowitz', 'SuperRare', 'https: / /superrare.com/joelmeyerowitz'),
        ...
        ('0x4765dfb514d05fae20a5a44ec4dd4b8e4209793b', 'Joel Sternfeld', 'Joel Sternfeld', 'SuperRare', 'https: / /www.superrare.com/joelsternfeld'),
        ('0x74c47b4e0cf7f181631ecb738ac8bd40577db256', 'John Divola', 'John Divola', 'SuperRare', 'https: / /www.superrare.com/johndivola'),
        ('0x5b23b7686f84191000329643a91ce33759005ead', 'Jonas Bendiksen', 'Jonas Bendiksen', 'Foundation', 'https: / /foundation.app/collection/jb-3ecd'),
        ('0xe58cd4b63a0cb3db983b1aa46dd62c2e47ed9a63', 'Katy Grannan', 'Katy Grannan', 'SuperRare', 'https: / /www.superrare.com/katygrannan'),
