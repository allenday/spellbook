...
WITH dexs AS(
  {% for evt_trade_table in onepunchswap_bnb_evt_trade_tables %}
    SELECT
        ...
        user                          AS taker,
        ''                            AS maker,
        cast(JSON_EXTRACT_SCALAR(quoteInfo,'$.toAmount') as FLOAT64) as token_bought_amount_raw,
        cast(JSON_EXTRACT_SCALAR(quoteInfo,'$.fromAmount') as FLOAT64) as token_sold_amount_raw,
        ...
        case 
            ...
            else JSON_EXTRACT_SCALAR(quoteInfo,'$.toAsset')
        ...
        case 
            ...
            else JSON_EXTRACT_SCALAR(quoteInfo,'$.fromAsset')
