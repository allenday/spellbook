...
WITH tff AS (
    ...
    FROM (SELECT call_block_time,
                 call_tx_hash,
                 JSON_EXTRACT_SCALAR(detail, '$.id')                                                     as id,
     ...
     tfe as (
         select evt_tx_hash,
                ...
                END as currency,
                (JSON_EXTRACT_SCALAR(inventory, '$.currency') = '0x0000000000000000000000000000000000000000') as native_matic,
                contract_address
