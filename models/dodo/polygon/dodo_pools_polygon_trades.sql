...
WITH dodo_view_markets AS (SELECT * FROM UNNEST(ARRAY<STRUCT<market_contract_address STRING,base_token_symbol STRING,quote_token_symbol STRING,base_token_address STRING,quote_token_address STRING>> [STRUCT(lower('0x813fddeccd0401c4fa73b092b074802440544e52'), 'USDC', 'USDT', lower('0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174'), lower('0xc2132D05D31c914a87C6611C10748AEb04B58e8F'))]))
, dexs AS 
(
