...
{% set project_start_date = '2021-04-17' %} -- min(evt_block_time) from spookyswap_fantom.Pair_evt_Swap
...
with dexs as (
    ...
    select
        ...
        t.evt_index
    from
        {{ source('spookyswap_fantom', 'Pair_evt_Swap') }} as t
    inner join {{ source('spookyswap_fantom', 'UniswapV2Factory_evt_PairCreated') }} as f
