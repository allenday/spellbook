     ...
     token as 
         (
             select token,
                    symbol,
                    decimals
             FROM UNNEST(ARRAY<STRUCT<token STRING,symbol STRING,decimals NUMERIC>> [STRUCT('0xb97ef9ef8734c71904d8002f8b6bc66dd9c48a6e', 'USDC', 6.0),
STRUCT('0x49d5c2bdffac6ce2bfdb6640f4f80f226bc10bab', 'WETH.e', 18.0),
STRUCT('0xa7d7079b0fead91f3e65f86e8915cb59c1a4c664', 'USDC.e', 6.0),
STRUCT('0xb31f66aa3c1e785363f0875a1b74e27b85fd66c7', 'WAVAX', 18.0),
STRUCT('0x50b7545627a5162f82a992c33b87adc75187b218', 'WBTC.e', 8.0),
STRUCT('0x130966628846bfd36ff31a822705796e8cb8c18d', 'MIM', 18.0),
STRUCT('0x152b9d0fdc40c096757f570a51e494bd4b943e50', 'BTC.b', 8.0)])
         ),
     minute_token as 
         (
             select *
     ...
     pool_amount as 
         (
             with pool_amount_raw as (
                 SELECT TIMESTAMP_TRUNC(call_block_time, minute) AS block_minute,
                        output_0                              as amount,
                        _0                                    as token
...
select usdc.minute                                      as minute,
       SAFE_CAST(TIMESTAMP_TRUNC(usdc.minute, DAY) AS date) as block_date,
