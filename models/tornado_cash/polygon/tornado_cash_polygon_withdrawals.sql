...
SELECT
    ...
    CASE
        WHEN tc.contract_address = '0x1e34a77868e19a6647b1f2f47b51ed72dede95dd' THEN 0.1
...
FROM {{ source('tornado_cash_polygon','TornadoCashMatic_evt_Withdrawal') }} AS tc
INNER JOIN {{ source('polygon','transactions') }} AS pt
    ON
        pt.hash = tc.evt_tx_hash
