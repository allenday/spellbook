...
SELECT
    ...
    CASE
        WHEN tc.contract_address = '0x84443cfd09a48af6ef360c6976c5392ac5023a1f' THEN 0.1
...
FROM {{ source('tornado_cash_optimism','ETHTornado_evt_Withdrawal') }} AS tc
INNER JOIN {{ source('optimism','transactions') }} AS ot
    ON
        ot.hash = tc.evt_tx_hash
