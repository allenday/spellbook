...
SELECT
    ...
    CAST(amount_raw / power(10, erc.decimals) * p.price as FLOAT64) AS amount_usd,
    CAST(amount_raw / power(10, erc.decimals) AS FLOAT64) AS amount_original,
    ...
    t.`from` AS tx_from,
    t.`to` AS tx_to,
    CAST(2 * amount_raw / 100 AS FLOAT64) AS platform_fee_amount_raw,
    CAST(2 * amount_raw / power(10, erc.decimals) / 100 AS FLOAT64) AS platform_fee_amount,
    CAST(2 * amount_raw / power(10, erc.decimals) * p.price / 100 AS FLOAT64) AS platform_fee_amount_usd,
    CAST(2 AS FLOAT64) AS platform_fee_percentage, -- Treasury 0xd4151c984e6cf33e04ffaaf06c3374b2926ecc64 receive MOD( 2, CAST)(0 AS FLOAT64) AS royalty_fee_amount_raw,
