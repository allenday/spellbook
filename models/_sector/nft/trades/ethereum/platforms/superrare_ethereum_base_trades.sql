...
left join {{ source('erc721_ethereum','evt_transfer') }} as minter
    on
        minter.contract_address = a.contract_address
...
left join {{ source('erc20_ethereum','evt_transfer') }} as minter_superrare
    on
        minter_superrare.contract_address = a.contract_address
