...
with cryptopunks_bids_and_sales as (
    ...
    select  "PunkBought" as event_type
            ...
            , cast(value/1e18 as FLOAT64) as sale_price   
            , cast(NULL as FLOAT64) as bid_amount 
            , toAddress as to_address
            , fromAddress as from_address 
            , cast(NULL as STRING) as bid_from_address 
            , evt_block_number 
            , evt_index
            , evt_block_time
            , evt_tx_hash
...
select  "ethereum" as blockchain
        ...
        , CAST((sale_price * 1e18) AS BIGNUMERIC) as amount_raw
...
left join {{ source('prices', 'usd') }} p on p.minute = TIMESTAMP_TRUNC(a.evt_block_time, minute)
