...
from
    (
        ...
        from {{ ref('nft_trades') }}
        where
            nft_contract_address = lower('0xb7f7f6c52f2e2fdb1963eab30438024864c313f6') -- wrapped punk contract
        ...
        select
            ...
            punk_id,
            case
                when `from` = '0x0000000000000000000000000000000000000000' then 'Claimed'
