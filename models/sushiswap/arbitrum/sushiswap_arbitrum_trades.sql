...
{% set project_start_date = '2021-08-31' %} -- min(evt_block_time) from sushi_arbitrum.Pair_evt_Swap
...
with dexs as (
    ...
    select
        ...
        t.evt_index
    from
        {{ source('sushi_arbitrum', 'Pair_evt_Swap') }} as t
    inner join {{ source('sushi_arbitrum', 'Factory_evt_PairCreated') }} as f
